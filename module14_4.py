...
button_buy = InlineKeyboardButton(text='от головы', callback_data="product_buying")
button_buy2 = InlineKeyboardButton(text='от похмелья', callback_data="product_buying")
button_buy3 = InlineKeyboardButton(text='от чег-ото еще', callback_data="product_buying")
button_buy4 = InlineKeyboardButton(text='просто нуно', callback_data="product_buying")
